package com.xy.easyanvils.core;
...
public class EasyAnvilsPlugin implements IFMLLoadingPlugin, IEarlyMixinLoader {
    ...
    public List<String> getMixinConfigs() {
        return Collections.singletonList("mixins.easyanvils.json");
    }
